            ...
            <div className="card">
                <div className="row">
                    <div className="col mb-4">
                        ...
                        <button className='btn btn-primary' id='click'><a href="#" className="text-white" style={{ textDecoration: 'none' }}>Click for more</a></button>
                    </div>
                    <div className="col mb-4">
                    <div className="col mb-4">
                        <img src="Hackathon.jpg" alt="image" />
                    ...
                    <div className="col mb-4">
                    <div className="col mb-4">
                        <img src="HighSchool.jpg" alt="image" />
                        <h2 className="card-title font-weight-bold">Student</h2><br/>
